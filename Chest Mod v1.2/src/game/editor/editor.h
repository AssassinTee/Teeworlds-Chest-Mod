...
public:
	...
	void MakeDoorLayer(CLayer *pLayer);
};
...
class CLayerDoor : public CLayerTiles
{
public:
	CLayerDoor(int w, int h);
	~CLayerDoor();
	
	CDoorTile *m_pDoorTile;
...
public:
	...
	static int PopupDoor(CEditor *pEditor, CUIRect View);
