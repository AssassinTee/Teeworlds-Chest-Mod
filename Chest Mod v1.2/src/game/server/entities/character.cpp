...
void CCharacter::Tick()
{
	...
	//Blue Stopper
	else if(TileIndex != -1 && GameServer()->Collision()->GetTileIndex(TileIndex) == TILE_STOPL_RED)
	{
	...
	else if(TileIndex != -1 && GameServer()->Collision()->GetTileIndex(TileIndex) == TILE_STOPR_RED)
	{
		if(m_pPlayer->GetTeam() == TEAM_RED)
		{
			if(m_Core.m_Vel.x < 0)
	...
	else if(TileIndex != -1 && GameServer()->Collision()->GetTileIndex(TileIndex) == TILE_STOPB_RED)
	{
		if(m_pPlayer->GetTeam() == TEAM_RED)
		{
			if(m_Core.m_Vel.y < 0)
	...
	else if(TileIndex != -1 && GameServer()->Collision()->GetTileIndex(TileIndex) == TILE_STOPT_RED)
	{
		if(m_pPlayer->GetTeam() == TEAM_RED)
		{
			if(m_Core.m_Vel.y > 0)
	...
	//Red Stopper	
	else if(TileIndex != -1 && GameServer()->Collision()->GetTileIndex(TileIndex) == TILE_STOPL_BLUE)
	{
	...
	else if(TileIndex != -1 && GameServer()->Collision()->GetTileIndex(TileIndex) == TILE_STOPR_BLUE)
	{
		if(m_pPlayer->GetTeam() == TEAM_BLUE)
		{
			if(m_Core.m_Vel.x < 0)
	...
	else if(TileIndex != -1 && GameServer()->Collision()->GetTileIndex(TileIndex) == TILE_STOPB_BLUE)
	{
		if(m_pPlayer->GetTeam() == TEAM_BLUE)
		{
			if(m_Core.m_Vel.y < 0)
	...
	else if(TileIndex != -1 && GameServer()->Collision()->GetTileIndex(TileIndex) == TILE_STOPT_BLUE)
	{
		if(m_pPlayer->GetTeam() == TEAM_BLUE)
		{
			if(m_Core.m_Vel.y > 0)
...
bool CCharacter::IncreaseHealth(int Amount)
{
	if(m_Health >= 10)
		return false;
	m_Health = clamp(m_Armor+Amount, 0, 10);
	return true;
}
